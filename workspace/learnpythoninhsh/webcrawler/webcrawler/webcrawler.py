...
class TianYanCha(object):
    ...
    def __init__(self, sucPath, failedPath):
        ...
        self.driver = webdriver.PhantomJS(executable_path = 'D:/Python27/phantomjs-2.0.0-windows/bin/phantomjs.exe')
    ...
    def getCompanyByName(self, company):
        url = 'http://www.tianyancha.com/search?key=%s&checkFrom=searchBox' % urllib2.quote(company)
...
def main():
    ...
    file = open('F:/all.txt')
    query.getCompanyByName('宁波中能塑胶贸易有限公司')
