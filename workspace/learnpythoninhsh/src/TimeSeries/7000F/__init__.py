...
P7000F=np.loadtxt('7000F.CSV')
P7000F=pd.Series(P7000F)
P7000F.index = pd.Index(sm.tsa.datetools.dates_from_range('2000M1',length=555))
print(P7000F)
plt.axis([0,555,8000,10200])
P7000F.plot(figsize=(8,6))
plt.show()
"""
